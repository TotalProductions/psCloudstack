...
param([parameter(Mandatory = $true, Position = 0)][string]$Server,
    ...
    switch ($browser.split("\")[-1]) {
      ...
      "iexplore.exe"  { $browserCmd = '$global:ie = New-Object -ComObject "InternetExplorer.Application";
    ...
    if ($ie) { [System.Runtime.Interopservices.Marshal]::ReleaseComObject($ie) | Out-Null }
